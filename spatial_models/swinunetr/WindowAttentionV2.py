...
class WindowAttentionV2(nn.Module):
    ...
    def __init__(
        ...
        if len(self.window_size) == 3:
            ...
            # A singleton temporal window is intentional for the architecture
            # baseline.  Its only relative displacement is zero, so normalize
            # by 1 instead of dividing by ``window_size - 1 == 0``.
